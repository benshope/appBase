...
import * as import11 from 'ionic-angular/components/tabs/tabs';
import * as import12 from 'ionic-angular/components/tabs/tab';
...
import * as import21 from '../../node_modules/ionic-angular/components/tabs/tab.ngfactory';
...
class _View_TabsPage_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._TabsPage_0_4 = new import3.TabsPage(this.parentInjector.get(import8.NavParams));
    this._appEl_0.initComponent(this._TabsPage_0_4,([] as any[]),compView_0);
...
export const TabsPageNgFactory:import10.ComponentFactory<import3.TabsPage> = new import10.ComponentFactory<import3.TabsPage>('ng-component',viewFactory_TabsPage_Host0,import3.TabsPage);
...
class _View_TabsPage0 extends import1.AppView<import3.TabsPage> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Tabs_0_4 = new import11.Tabs(this.parentInjector.get(import14.NavController,(null as any)),this.parentInjector.get(import15.ViewController,(null as any)),this.parentInjector.get(import16.App),this.parentInjector.get(import17.Config),new import18.ElementRef(this._el_0),this.parentInjector.get(import19.Platform),this.renderer,this.parentInjector.get(import20.DeepLinker));
    ...
    var compView_2:any = import21.viewFactory_Tab0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Tab_2_4 = new import12.Tab(this._Tabs_0_4,this.parentInjector.get(import16.App),this.parentInjector.get(import17.Config),this.parentInjector.get(import22.Keyboard),new import18.ElementRef(this._el_2),this.parentInjector.get(import23.NgZone),this.renderer,this.parentInjector.get(import24.ComponentFactoryResolver),compView_2.ref,this.parentInjector.get(import25.GestureController),this.parentInjector.get(import26.TransitionController),this.parentInjector.get(import20.DeepLinker,(null as any)));
    this._appEl_2.initComponent(this._Tab_2_4,([] as any[]),compView_2);
    compView_2.create(this._Tab_2_4,([] as any[]),(null as any));
    ...
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Speakers');
    this._appEl_4 = new import2.AppElement(4,0,this,this._el_4);
    var compView_4:any = import21.viewFactory_Tab0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Tab_4_4 = new import12.Tab(this._Tabs_0_4,this.parentInjector.get(import16.App),this.parentInjector.get(import17.Config),this.parentInjector.get(import22.Keyboard),new import18.ElementRef(this._el_4),this.parentInjector.get(import23.NgZone),this.renderer,this.parentInjector.get(import24.ComponentFactoryResolver),compView_4.ref,this.parentInjector.get(import25.GestureController),this.parentInjector.get(import26.TransitionController),this.parentInjector.get(import20.DeepLinker,(null as any)));
    this._appEl_4.initComponent(this._Tab_4_4,([] as any[]),compView_4);
    compView_4.create(this._Tab_4_4,([] as any[]),(null as any));
    ...
    this.renderer.setElementAttribute(this._el_6,'tabTitle','Map');
    this._appEl_6 = new import2.AppElement(6,0,this,this._el_6);
    var compView_6:any = import21.viewFactory_Tab0(this.viewUtils,this.injector(6),this._appEl_6);
    this._Tab_6_4 = new import12.Tab(this._Tabs_0_4,this.parentInjector.get(import16.App),this.parentInjector.get(import17.Config),this.parentInjector.get(import22.Keyboard),new import18.ElementRef(this._el_6),this.parentInjector.get(import23.NgZone),this.renderer,this.parentInjector.get(import24.ComponentFactoryResolver),compView_6.ref,this.parentInjector.get(import25.GestureController),this.parentInjector.get(import26.TransitionController),this.parentInjector.get(import20.DeepLinker,(null as any)));
    this._appEl_6.initComponent(this._Tab_6_4,([] as any[]),compView_6);
    compView_6.create(this._Tab_6_4,([] as any[]),(null as any));
    ...
    this.renderer.setElementAttribute(this._el_8,'tabTitle','About');
    this._appEl_8 = new import2.AppElement(8,0,this,this._el_8);
    var compView_8:any = import21.viewFactory_Tab0(this.viewUtils,this.injector(8),this._appEl_8);
    this._Tab_8_4 = new import12.Tab(this._Tabs_0_4,this.parentInjector.get(import16.App),this.parentInjector.get(import17.Config),this.parentInjector.get(import22.Keyboard),new import18.ElementRef(this._el_8),this.parentInjector.get(import23.NgZone),this.renderer,this.parentInjector.get(import24.ComponentFactoryResolver),compView_8.ref,this.parentInjector.get(import25.GestureController),this.parentInjector.get(import26.TransitionController),this.parentInjector.get(import20.DeepLinker,(null as any)));
    this._appEl_8.initComponent(this._Tab_8_4,([] as any[]),compView_8);
    compView_8.create(this._Tab_8_4,([] as any[]),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import12.Tab) && (2 === requestNodeIndex))) { return this._Tab_2_4; }
    if (((token === import12.Tab) && (4 === requestNodeIndex))) { return this._Tab_4_4; }
    if (((token === import12.Tab) && (6 === requestNodeIndex))) { return this._Tab_6_4; }
    if (((token === import12.Tab) && (8 === requestNodeIndex))) { return this._Tab_8_4; }
    if (((token === import11.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 9)))) { return this._Tabs_0_4; }
    return notFoundResult;
  }
