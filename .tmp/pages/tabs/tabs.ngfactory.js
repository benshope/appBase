...
export var TabsPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_TabsPage_Host0, import3.TabsPage);
var styles_TabsPage = [];
...
var _View_TabsPage0 = (function (_super) {
    ...
    _View_TabsPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._Tabs_0_4 = new import11.Tabs(this.parentInjector.get(import14.NavController, null), this.parentInjector.get(import15.ViewController, null), this.parentInjector.get(import16.App), this.parentInjector.get(import17.Config), new import18.ElementRef(this._el_0), this.parentInjector.get(import19.Platform), this.renderer, this.parentInjector.get(import20.DeepLinker));
        ...
        var compView_2 = import21.viewFactory_Tab0(this.viewUtils, this.injector(2), this._appEl_2);
        this._Tab_2_4 = new import12.Tab(this._Tabs_0_4, this.parentInjector.get(import16.App), this.parentInjector.get(import17.Config), this.parentInjector.get(import22.Keyboard), new import18.ElementRef(this._el_2), this.parentInjector.get(import23.NgZone), this.renderer, this.parentInjector.get(import24.ComponentFactoryResolver), compView_2.ref, this.parentInjector.get(import25.GestureController), this.parentInjector.get(import26.TransitionController), this.parentInjector.get(import20.DeepLinker, null));
        ...
        var compView_4 = import21.viewFactory_Tab0(this.viewUtils, this.injector(4), this._appEl_4);
        this._Tab_4_4 = new import12.Tab(this._Tabs_0_4, this.parentInjector.get(import16.App), this.parentInjector.get(import17.Config), this.parentInjector.get(import22.Keyboard), new import18.ElementRef(this._el_4), this.parentInjector.get(import23.NgZone), this.renderer, this.parentInjector.get(import24.ComponentFactoryResolver), compView_4.ref, this.parentInjector.get(import25.GestureController), this.parentInjector.get(import26.TransitionController), this.parentInjector.get(import20.DeepLinker, null));
        ...
        var compView_6 = import21.viewFactory_Tab0(this.viewUtils, this.injector(6), this._appEl_6);
        this._Tab_6_4 = new import12.Tab(this._Tabs_0_4, this.parentInjector.get(import16.App), this.parentInjector.get(import17.Config), this.parentInjector.get(import22.Keyboard), new import18.ElementRef(this._el_6), this.parentInjector.get(import23.NgZone), this.renderer, this.parentInjector.get(import24.ComponentFactoryResolver), compView_6.ref, this.parentInjector.get(import25.GestureController), this.parentInjector.get(import26.TransitionController), this.parentInjector.get(import20.DeepLinker, null));
        ...
        var compView_8 = import21.viewFactory_Tab0(this.viewUtils, this.injector(8), this._appEl_8);
        this._Tab_8_4 = new import12.Tab(this._Tabs_0_4, this.parentInjector.get(import16.App), this.parentInjector.get(import17.Config), this.parentInjector.get(import22.Keyboard), new import18.ElementRef(this._el_8), this.parentInjector.get(import23.NgZone), this.renderer, this.parentInjector.get(import24.ComponentFactoryResolver), compView_8.ref, this.parentInjector.get(import25.GestureController), this.parentInjector.get(import26.TransitionController), this.parentInjector.get(import20.DeepLinker, null));
    ...
    _View_TabsPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import12.Tab) && (2 === requestNodeIndex))) {
            return this._Tab_2_4;
        }
        if (((token === import12.Tab) && (4 === requestNodeIndex))) {
            return this._Tab_4_4;
        }
        if (((token === import12.Tab) && (6 === requestNodeIndex))) {
            return this._Tab_6_4;
        }
        if (((token === import12.Tab) && (8 === requestNodeIndex))) {
            return this._Tab_8_4;
        }
        if (((token === import11.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
