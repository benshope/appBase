...
var _View_MapPage_Host0 = (function (_super) {
    ...
    function _View_MapPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_MapPage_Host0, renderType_MapPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_MapPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0.initComponent(this._MapPage_0_4, [], compView_0);
        compView_0.create(this._MapPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_MapPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.MapPage) && (0 === requestNodeIndex))) {
            return this._MapPage_0_4;
        }
...
function viewFactory_MapPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MapPage_Host === null)) {
        (renderType_MapPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_MapPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var MapPageNgFactory = new import10.ComponentFactory('page-map', viewFactory_MapPage_Host0, import3.MapPage);
var styles_MapPage = [];
...
var _View_MapPage0 = (function (_super) {
    ...
    function _View_MapPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_MapPage0, renderType_MapPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_MapPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._MenuToggle_4_5 = new import14.MenuToggle(this.parentInjector.get(import27.MenuController), new import21.ElementRef(this._el_4), this.parentInjector.get(import22.ViewController, null), this._Navbar_2_4);
        ...
        this._text_10 = this.renderer.createText(null, 'Map', null);
        ...
        this._Content_14_4 = new import19.Content(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_14), this.renderer, this.parentInjector.get(import24.App), this.parentInjector.get(import30.Keyboard), this.parentInjector.get(import31.NgZone), this.parentInjector.get(import22.ViewController, null), this.parentInjector.get(import32.Tabs, null));
    ...
    _View_MapPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import19.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
    ...
    _View_MapPage0.prototype._handle_click_4_0 = function ($event) {
...
export function viewFactory_MapPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MapPage === null)) {
        (renderType_MapPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_MapPage, {}));
    }
