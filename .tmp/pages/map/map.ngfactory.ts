...
var renderType_MapPage_Host:import0.RenderComponentType = (null as any);
class _View_MapPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _MapPage_0_4:import3.MapPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_MapPage_Host0,renderType_MapPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MapPage_0_4 = new import3.MapPage(this.parentInjector.get(import8.ConferenceData));
    this._appEl_0.initComponent(this._MapPage_0_4,([] as any[]),compView_0);
    compView_0.create(this._MapPage_0_4,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.MapPage) && (0 === requestNodeIndex))) { return this._MapPage_0_4; }
    return notFoundResult;
  }
}
function viewFactory_MapPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_MapPage_Host === (null as any))) { (renderType_MapPage_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_MapPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const MapPageNgFactory:import10.ComponentFactory<import3.MapPage> = new import10.ComponentFactory<import3.MapPage>('page-map',viewFactory_MapPage_Host0,import3.MapPage);
const styles_MapPage:any[] = ([] as any[]);
var renderType_MapPage:import0.RenderComponentType = (null as any);
class _View_MapPage0 extends import1.AppView<import3.MapPage> {
  _el_0:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_MapPage0,renderType_MapPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._MenuToggle_4_5 = new import14.MenuToggle(this.parentInjector.get(import27.MenuController),new import21.ElementRef(this._el_4),this.parentInjector.get(import22.ViewController,(null as any)),this._Navbar_2_4);
    ...
    this._text_10 = this.renderer.createText((null as any),'Map',(null as any));
    ...
    this.renderer.setElementAttribute(this._el_14,'class','map-page');
    ...
    this._Content_14_4 = new import19.Content(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_14),this.renderer,this.parentInjector.get(import24.App),this.parentInjector.get(import30.Keyboard),this.parentInjector.get(import31.NgZone),this.parentInjector.get(import22.ViewController,(null as any)),this.parentInjector.get(import32.Tabs,(null as any)));
    ...
    this.renderer.setElementAttribute(this._el_16,'id','map');
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import19.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_14_4; }
    return notFoundResult;
  }
...
export function viewFactory_MapPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MapPage> {
  if ((renderType_MapPage === (null as any))) { (renderType_MapPage = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,styles_MapPage,{})); }
